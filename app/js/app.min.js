document.addEventListener("DOMContentLoaded", () => {
   ...
   if(widthScreen > 991) {
    ...
    var product = $('.product1').ThreeSixty({
        totalFrames: 55, // Total no. of image you have for 360 slider
        endFrame: 55, // end frame for the auto spin animation
        currentFrame: 1, // This the start frame for auto spin
        imgList: '.threesixty_images', // selector for image list
        progress: '.spinner', // selector to show the loading progress
        imagePath:'images/dist/sweet/', // path of the image assets
